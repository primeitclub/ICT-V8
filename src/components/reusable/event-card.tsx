        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-4 mb-12">
          ...
          <div className="text-white w-full">
            ...
            <div className="w-full flex gap-6 mt-4">
              ...
              <Button
                className="w-1/2 bg-transparent border-[#2C6DEC] border-2 text-white hover:scale-105 hover:bg-transparent hover:shadow-sm hover:border-[#003CD5] transition-all duration-300 ease-linear"
